  ...
  return (
    <section id="how-it-works" className="scroll-mt-20">
      <div className="mx-auto max-w-[1400px] px-6 py-10 md:py-16">
        ...
        <p className="mt-3 max-w-[50ch] text-base leading-relaxed text-zinc-500 dark:text-zinc-400">
          No integrations to configure, no code to write. Just your sales history and five minutes.
        </p>

        <div className="mt-16 grid gap-px overflow-hidden rounded-xl border border-zinc-200 bg-zinc-200 md:grid-cols-3 dark:border-zinc-800 dark:bg-zinc-800">
          {steps.map((step, i) => {
            const Icon = step.icon;
            return (
              <motion.div
                key={step.title}
                className="flex flex-col gap-4 bg-white p-8 dark:bg-zinc-950"
