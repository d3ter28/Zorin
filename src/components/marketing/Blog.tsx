    ...
    <section id="blog" className="scroll-mt-20">
      <div className="mx-auto max-w-[1400px] px-6 py-10 md:py-16">
        <div className="flex items-end justify-between">
          ...
          <a
            href="/blog"
            className="hidden text-sm font-medium text-blue-600 transition-colors hover:text-blue-700 md:block"
          >
            View all posts →
          </a>
        </div>
        ...
        <a
          href="/blog"
          className="mt-8 block text-sm font-medium text-blue-600 transition-colors hover:text-blue-700 md:hidden"
        >
          View all posts →
        </a>
      </div>
